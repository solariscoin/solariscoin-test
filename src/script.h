...
#ifndef H_solariscoin_SCRIPT
#define H_solariscoin_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CsolariscoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, solariscoin always counted CHECKMULTISIGs
