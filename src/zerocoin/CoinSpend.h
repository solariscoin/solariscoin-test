...
public:
	 ...
	 * (e.g from the most recent solariscoin block) containing the public part
	 ...
	 * @param m arbitrary meta data related to the spend that might be needed by solariscoin
