...
#ifndef _solariscoinRPC_H_
#define _solariscoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // solariscoin is not connected
...
/**
 * solariscoin RPC command dispatcher.
 */
class CRPCTable
{
private:
